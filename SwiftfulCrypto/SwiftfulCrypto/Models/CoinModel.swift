...
//  SwiftfulCrypto
//
//  Created by Ernest Gaisie on 31/01/2025.
//
...
// Coin Gecko API info'
/*
 'https://pro-api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=true&price_change_percentage=24h'
 */
